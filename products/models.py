...
class Product(models.Model):
    ...
    def update_stock(self, quantity, movement_type='in', user=None, reason=''):
        ...
        movement_type must match inventory.StockMovement.MOVEMENT_TYPES:
        'in', 'out', 'adjustment'
        (NOTE: 'return' is not yet a valid choice in StockMovement —
        to be added later as a 4th movement type)
        """
